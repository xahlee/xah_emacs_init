...
(global-set-key (kbd "s-,") 'xah-shrink-whitespaces)
(global-set-key (kbd "s-.") 'backward-kill-word)

(global-set-key (kbd "s-6") 'xah-select-current-block)
(global-set-key (kbd "s-7") 'xah-select-current-line)
(global-set-key (kbd "s-8") 'xah-extend-selection)
(global-set-key (kbd "s-9") 'xah-select-text-in-quote)

(global-set-key (kbd "s-SPC") 'set-mark-command)
(global-set-key (kbd "s-`") 'other-frame)
(global-set-key (kbd "s-b") 'xah-toggle-letter-case)
