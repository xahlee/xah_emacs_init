...
(defun xah-html-mode-keys ()
  ...
  (define-key xah-html-single-keys-keymap (kbd "SPC f") 'xah-copy-url-current-file)
  ...
  (define-key xah-html-single-keys-keymap (kbd "SPC p") nil)
  ...
  (define-key xah-html-single-keys-keymap (kbd "w a") 'xwe-annotate)
  (define-key xah-html-single-keys-keymap (kbd "w e") 'xwe-bold-word)
  (define-key xah-html-single-keys-keymap (kbd "w c") 'xwe-chinese-linkify)
  (define-key xah-html-single-keys-keymap (kbd "w m") 'xwe-move-word-to-page)
  (define-key xah-html-single-keys-keymap (kbd "w t") 'xwe-word-etymology-linkify)

  (define-key xah-html-single-keys-keymap (kbd "w n") 'xwe-new-word-entry )
  (define-key xah-html-single-keys-keymap (kbd "w i") 'xwe-insert-word-entry )
  (define-key xah-html-single-keys-keymap (kbd "w d") 'xwe-add-definition )
  (define-key xah-html-single-keys-keymap (kbd "w s") 'xwe-add-source )
  (define-key xah-html-single-keys-keymap (kbd "w c") 'xwe-add-comment )
  (define-key xah-html-single-keys-keymap (kbd "w g") 'xwe-search-next-unbold )
  (define-key xah-html-single-keys-keymap (kbd "w p") 'xwe-query-find-then-bold )
  (define-key xah-html-single-keys-keymap (kbd "w u") 'xwe-find-word-usage )
